			...
			<div className="mb-2">
				...
				<Row className="mt-4">
					<h4 className="text-center">
						Services at <span className="app-color"> iCar - </span>Hotel
						<span className="gap-2">
							<FaClock className="ml-5" /> 24-Hour
						</span>
					</h4>
				</Row>
				<hr />
					...
					<Col>
						<Card>
							<Card.Body>
								...
								<Card.Text>Enjoy a refreshing drink or snack from our in-car mini-bar.</Card.Text>
							</Card.Body>
						</Card>
					</Col>
					<Col>
