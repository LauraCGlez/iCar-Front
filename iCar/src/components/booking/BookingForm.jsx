				...
				<div className="row">
					<div className="col-md-6">
						<div className="card card-body mt-5">
							<h4 className="card-title">Reserve Car</h4>

							<Form noValidate validated={validated} onSubmit={handleSubmit}>
								<Form.Group>
									<Form.Label htmlFor="guestFullName" className="app-color">
										Fullname
									</Form.Label>
									<FormControl
										required
								...
								<Form.Group>
									<Form.Label htmlFor="guestEmail" className="app-color">
										Email
									</Form.Label>
									<FormControl
										required
								...
								<fieldset style={{ border: "2px" }}>
									...
									<div className="row">
										<div className="col-6">
											<Form.Label htmlFor="checkInDate" className="app-color">
												Check-in date
											</Form.Label>
											<FormControl
												required
										...
										<div className="col-6">
											<Form.Label htmlFor="checkOutDate" className="app-color">
												Check-out date
											</Form.Label>
											<FormControl
												required
